    ...
    <div>
            ...
            >
              ...
              <div class="text d-flex align-items-center ftco-animate">
                <div class="text-2 pb-lg-5 mb-lg-4 px-4 px-md-5">
                  ...
                  <p>
                    <a href="#" class="btn btn-black px-3 px-md-4 py-3">
                      Read More
              ...
              <div class="blog-entry">
                ...
                >
                  ...
                  <div class="text">
                    ...
                    <p class="mb-0">
                      <a href="single.html" class="btn-custom">
                        Read More
            ...
            <div class="col-lg-9">
              ...
              <div class="row">
                <div class="col-md-4 ftco-animate">
                  <div class="blog-entry">
                    <a href="single.html" class="img-2">
                      <img src="images/blog-1.jpg" class="img-fluid" alt="Colorlib Template" />
                    </a>
                    <div class="text pt-3">
                      <p class="meta d-flex">
                        <span class="pr-3">Dessert</span>
                        <span class="ml-auto pl-3">March 01, 2018</span>
                      </p>
                      <h3>
                        <a href="#">Tasty &amp; Delicious Foods</a>
                      </h3>
                      <p class="mb-0">
                        <a href="single.html" class="btn btn-black py-2">
                          Read More
                          <span class="icon-arrow_forward ml-4"></span>
                        </a>
                      </p>
                ...
                <div class="col-md-4 ftco-animate">
                  <div class="blog-entry">
                    <a href="single.html" class="img-2">
                      <img src="images/blog-2.jpg" class="img-fluid" alt="Colorlib Template" />
                    </a>
                    <div class="text pt-3">
                      <p class="meta d-flex">
                        <span class="pr-3">Dessert</span>
                ...
                <div class="col-md-4 ftco-animate">
                  <div class="blog-entry">
                    <a href="single.html" class="img-2">
                      <img src="images/blog-3.jpg" class="img-fluid" alt="Colorlib Template" />
                    </a>
                    <div class="text pt-3">
                      <p class="meta d-flex">
                        <span class="pr-3">Dessert</span>
              ...
              <div class="sidebar-wrap">
                <div class="sidebar-box p-4 about text-center ftco-animate">
                  ...
                  <div class="text pt-4">
                    <p>
                      Hi! My name is
                      <strong>Cathy Deon</strong>, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.
                    </p>
                  </div>
                </div>
      ...
      <section class="ftco-section ftco-no-pt ftco-section-about ftco-no-pb bg-darken">
        <div class="container-fluid">
          <div class="row">
            <div
              class="col-sm-6 col-md-6 col-lg-9 order-md-last img py-5"
              style="background-image: url(images/bg_3.jpg);"
            ></div>

            <div
              class="col-sm-6 col-md-6 col-lg-3 py-4 text d-flex align-items-center ftco-animate"
            >
              <div class="text-2 py-5 px-4">
                <p class="mb-5">
                  <a href="https://vimeo.com/45830194" class="btn-custom popup-vimeo">
                    Watch Video
                    <span class="ion-ios-play ml-4"></span>
                  </a>
                </p>
                <h1 class="mb-5">
                  Roger
                ...
                <p
                  class="mb-md-5"
                >A small river named Duden flows by their place and supplies it with the necessary regelialia. Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
            ...
            <div class="col-md-9">
              ...
              <div class="row">
                <div class="col-md-6 col-lg-6 ftco-animate">
                  <div class="blog-entry">
                    <div
                      class="img img-big img-big-2 d-flex align-items-end"
                  ...
                  <div class="blog-entry">
                    ...
                    >
                      ...
                      <div class="text">
                        ...
                        <h3>
                          <a href="#">White and red ceramic plate</a>
                        </h3>
                        <p class="mb-0">
                          <a href="#" class="btn-custom">
                            Read More
